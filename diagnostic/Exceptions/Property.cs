...
namespace Unity.Specification.Diagnostic.Exceptions
{
    public abstract partial class SpecificationTests
    {
        ...
        public void PropertyErrorLevel1()
        {
            ...
            // Act
            try { Container.Resolve<ClassWithStringProperty>(); }
        ...
        public void PropertyErrorLevel2()
        {
            ...
            // Act
            try { Container.Resolve<ClassWithStringPropertyDependency>(); }
            catch (Exception ex) { exception = ex; }
        ...
        public void PropertyWithNamedType()
        {
            ...
            // Act
            try { Container.Resolve<ClassWithNamedStringProperty>(); }
            catch (Exception ex) { exception = ex; }
